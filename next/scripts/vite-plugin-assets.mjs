...
//   ../final/google-doc-pre-course/*                → /final/google-doc-pre-course/*
//
...
const ALLOWED_PREFIXES = ["/audio/", "/source/daily/", "/final/google-doc-pre-course/"]
...
function resolveAsset(pathname) {
  ...
  if (decoded.startsWith("/final/google-doc-pre-course/")) {
    const okFinal =
      /\/images\//.test(decoded) ||
      /\/audio\//.test(decoded) ||
...
export function assetsPlugin() {
  return {
    ...
    writeBundle(options) {
      ...
      const finalSrc = join(REPO_ROOT, "final")
